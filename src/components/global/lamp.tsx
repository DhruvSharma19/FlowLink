  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-20 bg-gradient-to-br from-blue-300 to-purple-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Plans That
        <br /> Fit You Best
      </motion.h1>

          ...
          <div className='lg:flex w-full justify-between grid md:grid-cols-4 grid-cols-2 gap-6'>
            <div className='text-[#7d8590]'>
              ...
              <ul className='text-[14px]'>
                ...
                <li className='mb-4'><a href="">Compare FlowLink</a></li>
              </ul>
            </div>
            <div className='text-[#7d8590]'>
              ...
              <ul className='text-[14px]'>
                ...
                <li className='mb-4'><a href="">FlowLink Desktop</a></li>
              </ul>
            </div>
            <div className='text-[#7d8590]'>
              <h2 className='font-medium mb-4 font-mono'>Product</h2>
              <ul className='text-[14px]'>
                ...
                <li className='mb-4'><a href="">Contact FlowLink</a></li>
              </ul>
            </div>
            <div className='text-[#7d8590]'>
      ...
      <div className='bg-[#161b22]'>
        <div className='max-w-[1280px] mx-auto text-[12px] md:flex flex-row-reverse py-6 justify-between items-center px-4'>
          <ul className='flex items-center max-md:mb-4  '>
            <li className='mr-4'>
              <a href="https://x.com/DhruvSh81398975"><img src="https://github.githubassets.com/images/modules/site/icons/footer/twitter.svg" height="18" width="22" className="d-block" loading="lazy" decoding="async" alt="Twitter icon" /></a>
            </li>

            <li className='mr-4'>
              <a href="https://www.linkedin.com/in/dhruv-sharma-042198233"><img src="https://github.githubassets.com/images/modules/site/icons/footer/linkedin.svg" height="18" width="22" className="d-block" loading="lazy" decoding="async" alt="Twitter icon" /></a>
            </li>
            <li>
              <a href="https://github.com/DhruvSharma19"><img src="https://github.githubassets.com/images/modules/site/icons/footer/github-mark.svg" height="18" width="22" className="d-block" loading="lazy" decoding="async" alt="Twitter icon" /></a>
            </li>
          </ul>
          <ul className='flex items-center mb-4 sm:mb-0 text-[#7d8590] flex-wrap' >
            <li className="mr-3 ">© 2024 FlowLink, Inc.</li>
            ...
            <li className='mr-3 '><a href="">What is FlowLink?</a></li>
          </ul>
        </div>
      </div>
    </div>

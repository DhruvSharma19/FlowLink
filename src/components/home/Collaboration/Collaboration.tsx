      ...
      <div className='flex md:pl-7 space-x-3 md:space-x-10'>
            ...
            <motion.div initial={{opacity:0, x:-30}} whileInView={{opacity:1, x:0}} transition={{delay:0.6, type:'tween'}} className='md:w-10/12 mb-24'>
                ...
                <h3 className="text-[28px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl mb-7 font-medium text-white js-build-in-item build-in-slideX-left build-in-animate" style={{transitionDelay: '300ms'}}>
                    <span className="text-[#ffa28b]">Empower your workflow with FlowLink </span>
                     Seamlessly integrate your favorite services, craft custom automation sequences, and supercharge your productivity—unlocking new levels of efficiency and collaboration for you and your team.
                </h3>
            </motion.div>
        </div>
            ...
            <div className='flex justify-between md:space-x-10 max-md:flex-col'>
                <HoverCard backgroundColor='#ffa28b' direction='flex-col' left='0'>
                    <div className='md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-semibold'>FlowLink</span>  automates your workflow seamlessly by integrating popular services like Google Drive, Slack, Discord, and Notion, ensuring streamlined productivity and secure interactions.</p>
                        <div>
                ...
                <HoverCard backgroundColor='#ffa28b' direction='flex-col' left='-400px'>
                    <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-semibold'>FlowLink</span>  transforms your workflow landscape, seamlessly integrating your favorite tools and services to automate tasks and enhance productivity, wherever you are.</p>
                        <div>
        ...
        <HoverCard backgroundColor='#ffa28b' direction='' left=''>
          <div className='md:flex flex-col md:space-y-20 flex-1 py-20 p-10  justify-between'>
              <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>FlowLink</span>  enables you to streamline your workflows and automate tasks across various services, empowering you to boost productivity and efficiency in your daily operations</p>
              <div>

        ...
        <div className={`w-screen ${isFixed ? "fixed": "sticky"}  py-2 bg-[#0d1117] shadow-slate-950 shadow-md top-0 `}>
            <div className='max-w-[1280px] mx-auto pb-2 lg:pb-3 pt-1 flex lg:px-3 px-12 items-center max-lg:flex-col relative'>
              ...
              <div className={`lg:ml-5 flex items-center lg:space-x-5 max-lg:space-y-3 max-lg:flex-col max-lg:w-full max-lg:mt-5 ${smallNav ? "": "max-lg:hidden"}`}>
                  <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="/dashboard" className='flex items-center max-lg:w-full text-white font-semibold justify-center space-x-2 text-base  border-[1px] border-neutral-500 px-3 py-3 rounded-md'>
                  ...
                  <a onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="/dashboard" className='flex items-center max-lg:w-full bg-white text-black font-semibold px-3 py-3 justify-center rounded-md text-base'>
                    Get Started
